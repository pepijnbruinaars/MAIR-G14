...
label_to_index = {labels[x]:x for x in range(len(labels))} # create a dictionary mapping labels to index
index_to_label = {v:k for (k,v) in label_to_index.items()} # create a dictionary mapping index to labels
